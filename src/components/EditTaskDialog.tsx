        ...
        <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Due date handling:
                ...
                - Virtual recurring tasks: the date is the generated occurrence date (not a removable "due date")
                - Regular tasks: optional and removable
            */}
            {!task.rotating_task_id && (
              <div>
                {(task as any).isVirtual ? (
                  <>
                    <Label htmlFor="due_date">Occurrence Date</Label>
                    <Input
                      id="due_date"
                      type="date"
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      This date is generated by the recurrence schedule. To change when it happens, edit the recurrence settings.
                    </p>
                  </>
                ) : (
                  <>
