-- Add group contribution functionality to rewards
ALTER TYPE text ADD VALUE IF NOT EXISTS 'group_contribution';

-- Update the reward_type constraint to include the new type
...
ALTER TABLE rewards ADD CONSTRAINT rewards_reward_type_check 
  CHECK (reward_type IN ('once_off', 'always_available', 'group_contribution'));
